    ...
    <>
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed bottom-24 right-5 w-80 bg-white rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.15)] z-50 overflow-hidden"
          >
            {/* Header */}
            <div className="bg-[#c1972d] text-white p-4 flex justify-between items-center shadow-md">
              <div className="flex items-center gap-3">
                <div className="relative">
                  <div className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center font-bold">EI</div>
              ...
              {messages.map((msg, i) => (
                <motion.div
                  ...
                  className={`p-3 rounded-2xl text-sm shadow-sm ${
                    msg === "Yes" || msg === "No"
                      ? "bg-[#c1972d] text-white ml-auto rounded-tr-none"
              ...
              {step < botFlow.length && (
                ...
                >
                  <button
                    ...
                    className="flex-1 bg-green-500 hover:bg-green-600 text-white font-semibold py-2.5 rounded-xl transition-all active:scale-95 shadow-lg shadow-green-500/20"
                  >
                    Yes
                  </button>
                  <button
      ...
      <div className="fixed bottom-5 right-5 z-50">
        ...
        <motion.button
          ...
          className="relative bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-2xl flex items-center justify-center"
        >
          {open ? (
